...
struct zz_node *zz_pair_new(struct zz_ast *a, struct zz_node *data, struct zz_node *next);
int zz_is_pair(struct zz_node *n);
struct zz_pair *zz_pair(struct zz_node *n);

struct zz_node *zz_atom_new_with_len(struct zz_ast *a, const char *type, const char *str, int len);
struct zz_node *zz_atom_new(struct zz_ast *a, const char *type, const char *str);
